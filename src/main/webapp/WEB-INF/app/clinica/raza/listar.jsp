                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">
                                        <button class="btn btn-block btn-success" onclick="location = '<%=request.getContextPath()%>/raza/nuevo'">
                                            Nuevo
                                        </button>
                                    </h3>
                                </div><!-- /.box-header -->
                                <div class="box">
                                    <div class="box-header">
                                        <h3 class="box-title">Listar Razas</h3>
                                    </div><!-- /.box-header -->
                                    <div class="box-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <c:forEach items="${razas}" var="p">
                                                    <tr>
                                                        <td>${p.especie.nombre}</td>
                                                        <td>${p.nombre}</td>                                                        
                                                        <td>
                                                            <a href="<%=request.getContextPath()%>/raza/editar/${p.id}">Editar</a>
                                                            <a href="<%=request.getContextPath()%>/raza/eliminar/${p.id}">Eliminar</a>                                                            
                                                        </td>
                                                    </tr> 
                                                </c:forEach>
                                            </tbody>
