                        ...
                        <div class="col-md-6">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Registrar Raza</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form role="form" id="form" data-toggle="validator" action="<%=request.getContextPath()%>/raza/guardar">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="especie">Especie</label>
                                            <select class="form-control" name="especie.id">
                                                <c:forEach items="${especies}" var="u">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nombres" placeholder="Nombre" name="nombre">
                                        </div>
                                    </div><!-- /.box-body -->

                                    <div class="box-footer">
                                        <button type="submit" class="btn btn-primary">Registrar</button>
                                        <button type="button" class="btn btn-danger" onclick="location = '<%=request.getContextPath()%>/raza'">Cancelar</button>
                                    </div>
                                </form>
                            </div><!-- /.box -->
                        </div>
