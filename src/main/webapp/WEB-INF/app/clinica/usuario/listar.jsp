                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">
                                        <button class="btn btn-block btn-success" onclick="location = '<%=request.getContextPath()%>/usuario/nuevo'">
                                            Nuevo
                                        </button>
                                    </h3>
                                </div><!-- /.box-header -->
                                            ...
                                            <tbody>
                                                <c:forEach items="${usuarios}" var="u">
                                                    <tr>
                                                        ...
                                                        <td>${u.estado}</td>                                                                                                                
                                                        <td>
                                                            <a href="<%=request.getContextPath()%>/usuario/editar/${p.id}">Editar</a>
                                                            <a href="<%=request.getContextPath()%>/usuario/eliminar/${p.id}">Eliminar</a>                                                            
                                                        </td>
                                                    </tr> 
                                                </c:forEach>
                                            </tbody>
