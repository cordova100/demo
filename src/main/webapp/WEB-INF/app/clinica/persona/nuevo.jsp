                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form role="form" id="form" data-toggle="validator" action="<%=request.getContextPath()%>/persona/guardar">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" data-inputmask='"mask": "(999) 999-9999"' id="telefono" data-mask name="telefono"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="celular">Celular</label>
                                            <input type="text" class="form-control" data-inputmask='"mask": "999 999-999"' id="celular" data-mask name="celular"/>
                                        </div>

                                        <div class="form-group">
                                            <label for="direccion">Direccion</label>
                                            <input type="text" class="form-control" id="direccion" placeholder="Direccion" id="direccion" name="direccion">
                                        </div>

                                        <div class="form-group">
                                            <label>
                                                <input type="radio" name="sexo" class="minimal" checked value="1"/> MASCULINO
                                            </label>
                                            <label>
                                                <input type="radio" name="sexo" class="minimal" value="2"/> FEMENINO
                                            </label>                                            
                                        </div>
                                    </div><!-- /.box-body -->
