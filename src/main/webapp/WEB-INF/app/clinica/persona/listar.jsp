                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">
                                        <button class="btn btn-block btn-success" onclick="location = '<%=request.getContextPath()%>/persona/nuevo'">
                                            Nuevo
                                        </button>
                                    </h3>
                                </div><!-- /.box-header -->
                                <div class="box">
                                    <div class="box-header">
                                        <h3 class="box-title">Listar Personas</h3>
                                    </div><!-- /.box-header -->
                                    <div class="box-body">
                                            ...
                                            <tbody>
                                                <c:forEach items="${personas}" var="p">
                                                    <tr>
                                                        ...
                                                        <td>${p.telefono}</td>
                                                        <td>
                                                            <a href="<%=request.getContextPath()%>/persona/editar/${p.id}">Editar</a>
                                                            <a href="<%=request.getContextPath()%>/persona/eliminar/${p.id}">Eliminar</a>                                                            
                                                        </td>
                                                    </tr> 
                                                </c:forEach>
                                            </tbody>
